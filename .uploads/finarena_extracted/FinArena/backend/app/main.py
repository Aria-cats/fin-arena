"""Fin Arena backend entry: FastAPI app (CORS, routes, static SPA mount)."""
...
from .routes import admin, arena, backtest, cases, chat, forecast, logic, meta, playground

app = FastAPI(title="Fin Arena", version="3.12.0", docs_url="/api/docs")
...
def _startup() -> None:
    db.init_db()
    from .playground_store import init_playground_tables
    init_playground_tables()
    from .forecast_store import init_forecast_tables
